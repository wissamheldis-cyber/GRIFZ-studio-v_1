        ...
        {viewMode === 'selection' ? (
          ...
          >
            ...
            <div className="w-full h-full flex overflow-hidden">
              ...
              >
                <div 
                  className="absolute inset-0 rain-pattern opacity-30 group-hover/item:opacity-100 transition-opacity duration-700 pointer-events-none"
              ...
              {/* Ligne séparatrice */}
              <div className="w-px h-full bg-white/10 z-20 shadow-[0_0_15px_rgba(255,255,255,0.2)] relative"></div>
